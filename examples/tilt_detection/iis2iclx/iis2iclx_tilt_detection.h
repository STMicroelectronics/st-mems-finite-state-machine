...
#ifndef IIS2ICLX_TILT_DETECTION_H
#define IIS2ICLX_TILT_DETECTION_H
...
#define IIS2ICLX_TILT_DETECTION_SENSORS_NUM 1
...
static const char *const iis2iclx_tilt_detection_format_version = "2.0";
...
static const char *const iis2iclx_tilt_detection_names_0[] = {
    "IIS2ICLX"
};

static const struct mems_conf_name_list iis2iclx_tilt_detection_name_lists[IIS2ICLX_TILT_DETECTION_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op iis2iclx_tilt_detection_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x63, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x73, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x74, .data = 0x00 }
};

static const struct mems_conf_op_list iis2iclx_tilt_detection_confs[IIS2ICLX_TILT_DETECTION_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output iis2iclx_tilt_detection_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list iis2iclx_tilt_detection_output_lists[IIS2ICLX_TILT_DETECTION_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list iis2iclx_tilt_detection_mlc_identifier_lists[IIS2ICLX_TILT_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* IIS2ICLX_TILT_DETECTION_H */
