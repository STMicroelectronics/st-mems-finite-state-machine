...
#define IIS2ICLX_TILT_SENSORS_NUM 1
...
static const char *const iis2iclx_tilt_format_version = "2.0";

static const char *const iis2iclx_tilt_description = "Tilt detection";

static const struct mems_conf_application iis2iclx_tilt_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const iis2iclx_tilt_date = NULL;

/* Sensor names */

static const char *const iis2iclx_tilt_names_0[] = {
    "iis2iclx"
};

static const struct mems_conf_name_list iis2iclx_tilt_name_lists[IIS2ICLX_TILT_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_names_0) }
};

/* Configurations */

static const struct mems_conf_op iis2iclx_tilt_conf_0[] = {
...
static const struct mems_conf_op_list iis2iclx_tilt_confs[IIS2ICLX_TILT_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_conf_0) }
};

/* Outputs */

static const struct mems_conf_output iis2iclx_tilt_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list iis2iclx_tilt_output_lists[IIS2ICLX_TILT_SENSORS_NUM] = {
    { .list = iis2iclx_tilt_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2iclx_tilt_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list iis2iclx_tilt_mlc_identifier_lists[IIS2ICLX_TILT_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
