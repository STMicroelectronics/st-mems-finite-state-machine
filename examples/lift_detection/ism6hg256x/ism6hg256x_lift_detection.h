...
#ifndef ISM6HG256X_LIFT_DETECTION_H
#define ISM6HG256X_LIFT_DETECTION_H
...
#define ISM6HG256X_LIFT_DETECTION_SENSORS_NUM 1
...
static const char *const ism6hg256x_lift_detection_format_version = "2.0";

static const char *const ism6hg256x_lift_detection_description = "Lift detection";

static const struct mems_conf_application ism6hg256x_lift_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const ism6hg256x_lift_detection_date = NULL;

/* Sensor names */

static const char *const ism6hg256x_lift_detection_names_0[] = {
    "ISM6HG256X"
};

static const struct mems_conf_name_list ism6hg256x_lift_detection_name_lists[ISM6HG256X_LIFT_DETECTION_SENSORS_NUM] = {
    { .list = ism6hg256x_lift_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_lift_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op ism6hg256x_lift_detection_conf_0[] = {
...
static const struct mems_conf_op_list ism6hg256x_lift_detection_confs[ISM6HG256X_LIFT_DETECTION_SENSORS_NUM] = {
    { .list = ism6hg256x_lift_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_lift_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output ism6hg256x_lift_detection_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list ism6hg256x_lift_detection_output_lists[ISM6HG256X_LIFT_DETECTION_SENSORS_NUM] = {
    { .list = ism6hg256x_lift_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_lift_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list ism6hg256x_lift_detection_mlc_identifier_lists[ISM6HG256X_LIFT_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ISM6HG256X_LIFT_DETECTION_H */
