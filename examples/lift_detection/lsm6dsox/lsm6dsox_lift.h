...
#define LSM6DSOX_LIFT_SENSORS_NUM 1
...
static const char *const lsm6dsox_lift_format_version = "2.0";

static const char *const lsm6dsox_lift_description = "Lift detection";

static const struct mems_conf_application lsm6dsox_lift_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsox_lift_date = NULL;

/* Sensor names */

static const char *const lsm6dsox_lift_names_0[] = {
    "lsm6dsox"
};

static const struct mems_conf_name_list lsm6dsox_lift_name_lists[LSM6DSOX_LIFT_SENSORS_NUM] = {
    { .list = lsm6dsox_lift_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_lift_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsox_lift_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsox_lift_confs[LSM6DSOX_LIFT_SENSORS_NUM] = {
    { .list = lsm6dsox_lift_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_lift_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lsm6dsox_lift_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lsm6dsox_lift_output_lists[LSM6DSOX_LIFT_SENSORS_NUM] = {
    { .list = lsm6dsox_lift_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsox_lift_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsox_lift_mlc_identifier_lists[LSM6DSOX_LIFT_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
