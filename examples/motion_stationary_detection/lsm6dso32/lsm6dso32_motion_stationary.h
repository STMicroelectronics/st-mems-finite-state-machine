...
#define LSM6DSO32_MOTION_STATIONARY_SENSORS_NUM 1
...
static const char *const lsm6dso32_motion_stationary_format_version = "2.0";

static const char *const lsm6dso32_motion_stationary_description = "Motion-stationary detection";

static const struct mems_conf_application lsm6dso32_motion_stationary_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dso32_motion_stationary_date = NULL;
...
static const struct mems_conf_name_list lsm6dso32_motion_stationary_name_lists[LSM6DSO32_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = lsm6dso32_motion_stationary_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32_motion_stationary_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dso32_motion_stationary_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dso32_motion_stationary_confs[LSM6DSO32_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = lsm6dso32_motion_stationary_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dso32_motion_stationary_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lsm6dso32_motion_stationary_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lsm6dso32_motion_stationary_output_lists[LSM6DSO32_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = lsm6dso32_motion_stationary_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32_motion_stationary_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dso32_motion_stationary_mlc_identifier_lists[LSM6DSO32_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
