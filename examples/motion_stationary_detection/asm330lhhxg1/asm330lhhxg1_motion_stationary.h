...
#ifndef ASM330LHHXG1_MOTION_STATIONARY_H
#define ASM330LHHXG1_MOTION_STATIONARY_H
...
#define ASM330LHHXG1_MOTION_STATIONARY_SENSORS_NUM 1
...
static const char *const asm330lhhxg1_motion_stationary_format_version = "2.0";

static const char *const asm330lhhxg1_motion_stationary_description = "Motion-stationary detection";

static const struct mems_conf_application asm330lhhxg1_motion_stationary_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const asm330lhhxg1_motion_stationary_date = NULL;

/* Sensor names */

static const char *const asm330lhhxg1_motion_stationary_names_0[] = {
    "asm330lhhxg1"
};

static const struct mems_conf_name_list asm330lhhxg1_motion_stationary_name_lists[ASM330LHHXG1_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = asm330lhhxg1_motion_stationary_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhhxg1_motion_stationary_names_0) }
};

/* Configurations */

static const struct mems_conf_op asm330lhhxg1_motion_stationary_conf_0[] = {
...
static const struct mems_conf_op_list asm330lhhxg1_motion_stationary_confs[ASM330LHHXG1_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = asm330lhhxg1_motion_stationary_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(asm330lhhxg1_motion_stationary_conf_0) }
};

/* Outputs */

static const struct mems_conf_output asm330lhhxg1_motion_stationary_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list asm330lhhxg1_motion_stationary_output_lists[ASM330LHHXG1_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = asm330lhhxg1_motion_stationary_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhhxg1_motion_stationary_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list asm330lhhxg1_motion_stationary_mlc_identifier_lists[ASM330LHHXG1_MOTION_STATIONARY_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ASM330LHHXG1_MOTION_STATIONARY_H */
