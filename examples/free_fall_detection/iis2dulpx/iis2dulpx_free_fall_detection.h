...
#ifndef IIS2DULPX_FREE_FALL_DETECTION_H
#define IIS2DULPX_FREE_FALL_DETECTION_H
...
#define IIS2DULPX_FREE_FALL_DETECTION_SENSORS_NUM 1
...
static const char *const iis2dulpx_free_fall_detection_format_version = "2.0";

static const char *const iis2dulpx_free_fall_detection_description = "Free-fall detection";

static const struct mems_conf_application iis2dulpx_free_fall_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const iis2dulpx_free_fall_detection_date = NULL;

/* Sensor names */

static const char *const iis2dulpx_free_fall_detection_names_0[] = {
    "IIS2DULPX"
};

static const struct mems_conf_name_list iis2dulpx_free_fall_detection_name_lists[IIS2DULPX_FREE_FALL_DETECTION_SENSORS_NUM] = {
    { .list = iis2dulpx_free_fall_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_free_fall_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op iis2dulpx_free_fall_detection_conf_0[] = {
...
static const struct mems_conf_op_list iis2dulpx_free_fall_detection_confs[IIS2DULPX_FREE_FALL_DETECTION_SENSORS_NUM] = {
    { .list = iis2dulpx_free_fall_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_free_fall_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output iis2dulpx_free_fall_detection_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list iis2dulpx_free_fall_detection_output_lists[IIS2DULPX_FREE_FALL_DETECTION_SENSORS_NUM] = {
    { .list = iis2dulpx_free_fall_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(iis2dulpx_free_fall_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list iis2dulpx_free_fall_detection_mlc_identifier_lists[IIS2DULPX_FREE_FALL_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* IIS2DULPX_FREE_FALL_DETECTION_H */
