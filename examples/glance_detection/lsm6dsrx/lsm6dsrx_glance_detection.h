...
#ifndef LSM6DSRX_GLANCE_DETECTION_H
#define LSM6DSRX_GLANCE_DETECTION_H
...
#define LSM6DSRX_GLANCE_DETECTION_SENSORS_NUM 1
...
static const char *const lsm6dsrx_glance_detection_format_version = "2.0";

static const char *const lsm6dsrx_glance_detection_description = "Glance detection";

static const struct mems_conf_application lsm6dsrx_glance_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsrx_glance_detection_date = NULL;

/* Sensor names */

static const char *const lsm6dsrx_glance_detection_names_0[] = {
    "LSM6DSRX"
};

static const struct mems_conf_name_list lsm6dsrx_glance_detection_name_lists[LSM6DSRX_GLANCE_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsrx_glance_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_glance_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsrx_glance_detection_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsrx_glance_detection_confs[LSM6DSRX_GLANCE_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsrx_glance_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_glance_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lsm6dsrx_glance_detection_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lsm6dsrx_glance_detection_output_lists[LSM6DSRX_GLANCE_DETECTION_SENSORS_NUM] = {
    { .list = lsm6dsrx_glance_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsrx_glance_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsrx_glance_detection_mlc_identifier_lists[LSM6DSRX_GLANCE_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSRX_GLANCE_DETECTION_H */
