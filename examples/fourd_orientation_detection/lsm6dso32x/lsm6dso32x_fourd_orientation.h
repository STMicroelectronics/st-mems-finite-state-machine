...
#ifndef LSM6DSO32X_FOURD_ORIENTATION_H
#define LSM6DSO32X_FOURD_ORIENTATION_H
...
#define LSM6DSO32X_FOURD_ORIENTATION_SENSORS_NUM 1
...
static const char *const lsm6dso32x_fourd_orientation_format_version = "2.0";

static const char *const lsm6dso32x_fourd_orientation_description = "4D orientation detection";

static const struct mems_conf_application lsm6dso32x_fourd_orientation_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dso32x_fourd_orientation_date = NULL;

/* Sensor names */

static const char *const lsm6dso32x_fourd_orientation_names_0[] = {
    "LSM6DSO32X"
};

static const struct mems_conf_name_list lsm6dso32x_fourd_orientation_name_lists[LSM6DSO32X_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lsm6dso32x_fourd_orientation_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_fourd_orientation_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dso32x_fourd_orientation_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dso32x_fourd_orientation_confs[LSM6DSO32X_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lsm6dso32x_fourd_orientation_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_fourd_orientation_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lsm6dso32x_fourd_orientation_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lsm6dso32x_fourd_orientation_output_lists[LSM6DSO32X_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lsm6dso32x_fourd_orientation_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dso32x_fourd_orientation_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dso32x_fourd_orientation_mlc_identifier_lists[LSM6DSO32X_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LSM6DSO32X_FOURD_ORIENTATION_H */
