...
#ifndef LIS2DUX12_FOURD_ORIENTATION_H
#define LIS2DUX12_FOURD_ORIENTATION_H
...
#define LIS2DUX12_FOURD_ORIENTATION_SENSORS_NUM 1
...
static const char *const lis2dux12_fourd_orientation_format_version = "2.0";

static const char *const lis2dux12_fourd_orientation_description = "4D orientation detection";

static const struct mems_conf_application lis2dux12_fourd_orientation_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lis2dux12_fourd_orientation_date = NULL;

/* Sensor names */

static const char *const lis2dux12_fourd_orientation_names_0[] = {
    "lis2dux12"
};

static const struct mems_conf_name_list lis2dux12_fourd_orientation_name_lists[LIS2DUX12_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lis2dux12_fourd_orientation_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_fourd_orientation_names_0) }
};

/* Configurations */

static const struct mems_conf_op lis2dux12_fourd_orientation_conf_0[] = {
...
static const struct mems_conf_op_list lis2dux12_fourd_orientation_confs[LIS2DUX12_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lis2dux12_fourd_orientation_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lis2dux12_fourd_orientation_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lis2dux12_fourd_orientation_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lis2dux12_fourd_orientation_output_lists[LIS2DUX12_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = lis2dux12_fourd_orientation_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_fourd_orientation_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lis2dux12_fourd_orientation_mlc_identifier_lists[LIS2DUX12_FOURD_ORIENTATION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* LIS2DUX12_FOURD_ORIENTATION_H */
