...
#ifndef ASM330LHB_SHAKE_H
#define ASM330LHB_SHAKE_H
...
#define ASM330LHB_SHAKE_SENSORS_NUM 1
...
static const char *const asm330lhb_shake_format_version = "2.0";

static const char *const asm330lhb_shake_description = "Shake detection";

static const struct mems_conf_application asm330lhb_shake_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const asm330lhb_shake_date = NULL;
...
static const struct mems_conf_name_list asm330lhb_shake_name_lists[ASM330LHB_SHAKE_SENSORS_NUM] = {
    { .list = asm330lhb_shake_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhb_shake_names_0) }
};

/* Configurations */

static const struct mems_conf_op asm330lhb_shake_conf_0[] = {
...
static const struct mems_conf_op_list asm330lhb_shake_confs[ASM330LHB_SHAKE_SENSORS_NUM] = {
    { .list = asm330lhb_shake_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(asm330lhb_shake_conf_0) }
};

/* Outputs */

static const struct mems_conf_output asm330lhb_shake_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list asm330lhb_shake_output_lists[ASM330LHB_SHAKE_SENSORS_NUM] = {
    { .list = asm330lhb_shake_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(asm330lhb_shake_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list asm330lhb_shake_mlc_identifier_lists[ASM330LHB_SHAKE_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
