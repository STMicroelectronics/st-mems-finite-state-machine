...
#define LSM6DSV16B_FLIP_UP_SENSORS_NUM 1
...
static const char *const lsm6dsv16b_flip_up_format_version = "2.0";

static const char *const lsm6dsv16b_flip_up_description = "Flip-up detection";

static const struct mems_conf_application lsm6dsv16b_flip_up_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lsm6dsv16b_flip_up_date = NULL;

/* Sensor names */

static const char *const lsm6dsv16b_flip_up_names_0[] = {
    "lsm6dsv16b"
};

static const struct mems_conf_name_list lsm6dsv16b_flip_up_name_lists[LSM6DSV16B_FLIP_UP_SENSORS_NUM] = {
    { .list = lsm6dsv16b_flip_up_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv16b_flip_up_names_0) }
};

/* Configurations */

static const struct mems_conf_op lsm6dsv16b_flip_up_conf_0[] = {
...
static const struct mems_conf_op_list lsm6dsv16b_flip_up_confs[LSM6DSV16B_FLIP_UP_SENSORS_NUM] = {
    { .list = lsm6dsv16b_flip_up_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lsm6dsv16b_flip_up_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lsm6dsv16b_flip_up_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lsm6dsv16b_flip_up_output_lists[LSM6DSV16B_FLIP_UP_SENSORS_NUM] = {
    { .list = lsm6dsv16b_flip_up_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lsm6dsv16b_flip_up_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lsm6dsv16b_flip_up_mlc_identifier_lists[LSM6DSV16B_FLIP_UP_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
