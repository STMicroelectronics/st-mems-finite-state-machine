...
#ifndef ISM6HG256X_PEAK_TRACKING_H
#define ISM6HG256X_PEAK_TRACKING_H
...
#define ISM6HG256X_PEAK_TRACKING_SENSORS_NUM 1
...
static const char *const ism6hg256x_peak_tracking_format_version = "2.0";

static const char *const ism6hg256x_peak_tracking_description = "Peak tracking";

static const struct mems_conf_application ism6hg256x_peak_tracking_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const ism6hg256x_peak_tracking_date = NULL;

/* Sensor names */

static const char *const ism6hg256x_peak_tracking_names_0[] = {
    "ISM6HG256X"
};

static const struct mems_conf_name_list ism6hg256x_peak_tracking_name_lists[ISM6HG256X_PEAK_TRACKING_SENSORS_NUM] = {
    { .list = ism6hg256x_peak_tracking_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_peak_tracking_names_0) }
};

/* Configurations */

static const struct mems_conf_op ism6hg256x_peak_tracking_conf_0[] = {
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x5F, .data = 0x6B },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x17, .data = 0x82 },
    ...
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x0A, .data = 0x06 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x63, .data = 0x70 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x10, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x11, .data = 0x00 },
    { .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x4E, .data = 0x9C }
};

static const struct mems_conf_op_list ism6hg256x_peak_tracking_confs[ISM6HG256X_PEAK_TRACKING_SENSORS_NUM] = {
    { .list = ism6hg256x_peak_tracking_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_peak_tracking_conf_0) }
};
...
static const struct mems_conf_output_list ism6hg256x_peak_tracking_output_lists[ISM6HG256X_PEAK_TRACKING_SENSORS_NUM] = {
    { .list = ism6hg256x_peak_tracking_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(ism6hg256x_peak_tracking_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list ism6hg256x_peak_tracking_mlc_identifier_lists[ISM6HG256X_PEAK_TRACKING_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
...
#endif /* ISM6HG256X_PEAK_TRACKING_H */
