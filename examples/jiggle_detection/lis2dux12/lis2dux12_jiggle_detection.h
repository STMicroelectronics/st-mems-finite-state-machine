...
#define LIS2DUX12_JIGGLE_DETECTION_SENSORS_NUM 1
...
static const char *const lis2dux12_jiggle_detection_format_version = "2.0";

static const char *const lis2dux12_jiggle_detection_description = "Jiggle detection";

static const struct mems_conf_application lis2dux12_jiggle_detection_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const lis2dux12_jiggle_detection_date = NULL;

/* Sensor names */

static const char *const lis2dux12_jiggle_detection_names_0[] = {
    "LIS2DUX12"
};

static const struct mems_conf_name_list lis2dux12_jiggle_detection_name_lists[LIS2DUX12_JIGGLE_DETECTION_SENSORS_NUM] = {
    { .list = lis2dux12_jiggle_detection_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_jiggle_detection_names_0) }
};

/* Configurations */

static const struct mems_conf_op lis2dux12_jiggle_detection_conf_0[] = {
...
static const struct mems_conf_op_list lis2dux12_jiggle_detection_confs[LIS2DUX12_JIGGLE_DETECTION_SENSORS_NUM] = {
    { .list = lis2dux12_jiggle_detection_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(lis2dux12_jiggle_detection_conf_0) }
};

/* Outputs */

static const struct mems_conf_output lis2dux12_jiggle_detection_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list lis2dux12_jiggle_detection_output_lists[LIS2DUX12_JIGGLE_DETECTION_SENSORS_NUM] = {
    { .list = lis2dux12_jiggle_detection_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(lis2dux12_jiggle_detection_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list lis2dux12_jiggle_detection_mlc_identifier_lists[LIS2DUX12_JIGGLE_DETECTION_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
