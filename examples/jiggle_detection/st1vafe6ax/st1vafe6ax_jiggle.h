...
#ifndef ST1VAFE6AX_JIGGLE_H
#define ST1VAFE6AX_JIGGLE_H
...
#define ST1VAFE6AX_JIGGLE_SENSORS_NUM 1
...
static const char *const st1vafe6ax_jiggle_format_version = "2.0";

static const char *const st1vafe6ax_jiggle_description = "Jiggle detection";

static const struct mems_conf_application st1vafe6ax_jiggle_application = {
    .name = "Configuration Converter Tool",
    .version = "1.0"
};

static const char *const st1vafe6ax_jiggle_date = NULL;

/* Sensor names */

static const char *const st1vafe6ax_jiggle_names_0[] = {
    "st1vafe6ax"
};

static const struct mems_conf_name_list st1vafe6ax_jiggle_name_lists[ST1VAFE6AX_JIGGLE_SENSORS_NUM] = {
    { .list = st1vafe6ax_jiggle_names_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_jiggle_names_0) }
};

/* Configurations */

static const struct mems_conf_op st1vafe6ax_jiggle_conf_0[] = {
...
static const struct mems_conf_op_list st1vafe6ax_jiggle_confs[ST1VAFE6AX_JIGGLE_SENSORS_NUM] = {
    { .list = st1vafe6ax_jiggle_conf_0, .len = (uint32_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_jiggle_conf_0) }
};

/* Outputs */

static const struct mems_conf_output st1vafe6ax_jiggle_outputs_0[] = {
    {
        .name = "FSM1",
...
static const struct mems_conf_output_list st1vafe6ax_jiggle_output_lists[ST1VAFE6AX_JIGGLE_SENSORS_NUM] = {
    { .list = st1vafe6ax_jiggle_outputs_0, .len = (uint16_t)MEMS_CONF_ARRAY_LEN(st1vafe6ax_jiggle_outputs_0) }
};

/* MLC identifiers */

static const struct mems_conf_mlc_identifier_list st1vafe6ax_jiggle_mlc_identifier_lists[ST1VAFE6AX_JIGGLE_SENSORS_NUM] = {
    { .list = NULL, .len = 0 }
};
